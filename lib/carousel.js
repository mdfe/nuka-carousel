...
var Carousel = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    heightIndex: _propTypes2.default.number
  },
  ...
  setDimensions: function setDimensions(props) {
    ...
    if (firstSlide) {
      ...
      slideHeight = this.props.vertical ? firstSlide.offsetHeight * props.slidesToShow : frame.childNodes[0].childNodes[props.heightIndex].offsetHeight;
    } else {
      slideHeight = 100;
    }
